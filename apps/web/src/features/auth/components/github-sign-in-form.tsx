...
function SubmitButton() {
  ...
  return (
    <Button
      className="group w-full flex items-center justify-center gap-md bg-white text-[#0D1117]! py-md px-lg rounded-lg font-label-caps text-label-caps transition-all hover:bg-neutral-100 active:scale-[0.98] duration-150 shadow-sm hover:cursor-pointer mb-md"
      disabled={pending}
    >
      {buttonIcon}
      {buttonLabel}
